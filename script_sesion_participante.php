...
$sql="SELECT * FROM usuarioss WHERE id_usuario='$id_usuario' AND contrasena='$contrasena' AND tipo_usuario='3'";
...
if($result->num_rows>0){
	$_SESSION['participante']=$id_usuario;
	$_SESSION['sesion_participante']="creada";
	header ("Location: index_participante.php");
						            ...
						            echo "<br><br><p>Id o contraseña incorrecta</p>";
              						echo "<br><a href=\"sesion_participante.php\" class=\"btn btn-primary\">Regresar</a><br><br>";
              						echo "</div>
						            <!-- /.container -->
