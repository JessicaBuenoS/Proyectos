...
$id_agenda=$id_evento.$id_tipo;
//subir imagen
$dir_subida = 'imagenes_eventos/';
...
//echo $imagen;
//echo "<img src=imagenes_eventos/".$imagen.">";




$sql = "INSERT INTO eventos (id_evento, nombre_evento, descripcion_evento, lugar, fecha_inicio, fecha_fin, fecha_inscripcion, cupo, id_agenda, costo, id_tipo, id_coordinador, id_carrera, imagen)
VALUES ('".$id_evento."','".$nombre_evento."','".$descripcion_evento."','".$lugar."', '".$fecha_inicio."', '".$fecha_fin."', '".$fecha_inscripcion."','".$cupo."', '".$id_agenda."', '".$costo."','".$id_tipo."', '".$id_coordinador."', '".$id_carrera."', '".$imagen."')";

$sql2 = "INSERT INTO agenda (id_agenda, id_evento)
VALUES ('".$id_agenda."', '".$id_evento."')";
