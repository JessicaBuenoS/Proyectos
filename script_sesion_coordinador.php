...
$sql="SELECT * FROM usuarioss WHERE id_usuario='$id_usuario' AND contrasena='$contrasena' AND tipo_usuario='2'";
	...
	header ("Location: index_coordinador.php");
							        ...
							        <html lang=\"es\">
							          ...
							          <head>
							            ...
							            <title>Sesión coordinador - Eventos UP</title>
						            ...
						            <div class=\"container\">
						              ...
						              <ol class=\"breadcrumb\">
						                ...
						                <li class=\"breadcrumb-item active\">Iniciar sesión coordinador</li>
						              </ol>";

						            echo "<br><br><p>Id o contraseña incorrecta</p>";
              						echo "<br><a href=\"sesion_coordinador.php\" class=\"btn btn-primary\">Regresar</a><br><br>";
              						echo "</div>
						            <!-- /.container -->
